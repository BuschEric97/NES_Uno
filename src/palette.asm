...
.segment "ROMDATA"
palette_background:
.byte BLACK,    MEDIUM_GRAY,    MEDIUM_BLUE,    LIGHT_BLUE
.byte BLACK,    DARK_BLUE,      MEDIUM_BLUE,    LIGHT_BLUE
.byte BLACK,    BLACK,          DARK_BLUE,      MEDIUM_BLUE
.byte BLACK,    DARK_GRAY,      MEDIUM_GRAY,    LIGHTEST_GRAY

palette_sprites:
.byte BLACK,    DARK_GRAY,      MEDIUM_GRAY,    LIGHT_GRAY
.byte BLACK,    MEDIUM_GRAY,    LIGHT_GRAY,     LIGHTEST_GRAY
